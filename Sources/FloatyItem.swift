...
open class FloatyItem: UIView {
    ...
    open var size: CGFloat = 42 {
        didSet {
            self.frame = CGRect(x: 0, y: 0, width: size + 4, height: size + 4)
    ...
    open var titleLabel: UILabel {
        get {
            if _titleLabel == nil {
                ...
                _titleLabel?.font = UIFont.init(name: "OpenSans-Regular", size: 14)
    ...
    open var title: String? = nil {
        didSet {
            ...
            titleLabel.frame = CGRect.init(x: titleLabel.frame.minX, y: titleLabel.frame.minY, width: titleLabel.frame.width + 8, height: titleLabel.frame.height + 4)
